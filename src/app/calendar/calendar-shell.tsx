...
import { useCalendarOverlays, useLunarRepeat } from "./calendar-prefs";
...
export function CalendarShell({
  ...
  // (拜拜, 诵经…). A device preference; derived events, never stored.
  const [lunarRepeat, setLunarRepeat] = useLunarRepeat();
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 pb-8">
      ...
      {/* #13/#15: secondary calendars (opt-in) + the lunar-recurring rule
          with the society's own word — one controls row, calendar-controls. */}
      <CalendarControls
        overlays={overlays}
