...
> = {
  committee: {
    ...
    notes: [
      ...
      "",
      "Jawatan dan Nama WAJIB. Lajur lain pilihan.",
      "「职位」和「姓名」一定要填。其他栏是选填。",
      "Position and Name are required. The other columns are optional.",
      "",
  ...
  glossary: {
    ...
    notes: [
      ...
      "",
      "Lajur ketiga pilihan — ia membantu MinitAI membezakan perkataan seakan.",
      "第三栏是选填 —— 填了 MinitAI 比较不会认错相似的词。",
