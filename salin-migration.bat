...
echo    45.  20260923000000  kira kuota AI secara atom - dua permintaan serentak tak lagi lepas (122 nombor 3)
echo    46.  20260924000000  senarai AJK: No. K/P, alamat, pekerjaan - kad "tambah ke senarai" isi sendiri (130 nombor 11)
...
if "%pick%"=="45" set f=20260923000000_charge_ai_action.sql& goto copy
if "%pick%"=="46" set f=20260924000000_roster_particulars.sql& goto copy
